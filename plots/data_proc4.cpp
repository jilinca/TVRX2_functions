...
int main(){
    ...
    // Vector to read data into;
    cf2vec ch_data(NUM_CHANNELS, std::vector<std::complex<float>>(n_samps/NUM_CHANNELS));
    ...
    */
    ...
    // MAYBE TRY DIVIDING by 4
    //std::vector<std::complex<float> > dv1(nsamps/2);
    //std::vector<std::complex<float> > dv2(nsamps/2);
    //std::vector<std::complex<float> > dv3(nsamps/2);
    //std::vector<std::complex<float> > dv4(nsamps/2);
    // Alternative vector
    //std::vector<std::vector<std::complex<float> > > dv(NUM_CHANNELS4, 
    //        std::vector<std::complex<float>>(n_samps/4));
    ...
    i_f3.read(reinterpret_cast<char*>(dv3.data()), nsamps*sizeof(float));
    i_f4.read(reinterpret_cast<char*>(dv4.data()), nsamps*sizeof(float));
